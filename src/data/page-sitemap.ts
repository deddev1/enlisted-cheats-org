...
const sitemapImagesByPageId: Partial<Record<PageId, SitemapImage[]>> = {
	...
	hacks: [
		img(enlistedImages.battleRoyaleCombat, 'Enlisted Cheats', 'Enlisted cheats frontline campaign fight preview'),
		img(enlistedImages.espWallhack, 'Enlisted Cheats ESP', 'Enlisted wallhack ESP on Axis, Allied, and heavy vehicles'),
	],
	'enlisted-esp': [
		img(enlistedImages.espWallhack, 'Enlisted ESP', 'Enlisted ESP wallhack overlay'),
