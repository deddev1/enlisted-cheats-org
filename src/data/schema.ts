	...
	'enlisted-esp': [
		{
			...
			answer:
				'A Enlisted wallhack is an ESP overlay that shows enemy units and heavy vehicles, heavy attacks, and loot through cover. Enlisted Cheats wallhack includes distance readouts, team colours, and toggleable categories for frontline campaigns and large-scale battles.',
		},
		{
		...
		{
			question: 'Does this fit frontline campaigns and large-scale battles runs?',
			answer:
