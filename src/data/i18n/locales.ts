...
> = {
	en: {
		...
		blogDescription:
			'Enlisted game guides on frontline campaigns, large-scale battles, factions, missions, and patch notes — plus ESP, aimbot, and anti-cheat product guides with official Wiki links.',
		blogH1: 'Enlisted Guides & Intel',
		blogIntro:
			'Game guides for frontline campaigns, large-scale battle farming, factions, mission types, and patch notes — linked to the Enlisted Wiki and Darkflow Software. Plus product guides for ESP, soft aim, radar, and anti-cheat maintenance.',
		readMore: 'Read guide',
		published: 'Published',
		updated: 'Updated',
	...
	es: {
		...
		blogIntro:
			'Guías SEO de trucos Enlisted indetectables, ESP wallhack, radar hack, Aimbot y mantenimiento Darkflow Software anti-cheat (EAC) en 22 idiomas.',
		readMore: 'Leer guía',
		published: 'Publicado',
		updated: 'Actualizado',
	...
	fr: {
		...
		blogIntro:
			'Guides SEO triches Enlisted indétectables, ESP wallhack, radar hack, Aimbot et Darkflow Software anti-cheat (EAC) en 22 langues.',
	...
	de: {
		...
		blogIntro:
			'SEO-Guides für undetected Enlisted Cheats, ESP Wallhack, Radar Hack, Aimbot und Darkflow Software anti-cheat (EAC) in 22 Sprachen.',
	...
	pt: {
		...
		blogIntro:
			'Guias SEO de cheats Enlisted indetectáveis, ESP wallhack, radar hack, Aimbot e Darkflow Software anti-cheat (EAC) em 22 idiomas.',
		readMore: 'Ler guia',
		published: 'Publicado',
		updated: 'Atualizado',
	...
	it: {
		...
		blogIntro:
			'Guide SEO cheat Enlisted indetectable, ESP wallhack, radar hack, Aimbot e Darkflow Software anti-cheat (EAC) in 22 lingue.',
	...
	nl: {
		...
		blogIntro:
			'SEO-gidsen voor undetected Enlisted cheats, ESP wallhack, radar hack, Aimbot en Darkflow Software anti-cheat (EAC) in 22 talen.',
		readMore: 'Lees gids',
	...
	pl: {
		...
		blogIntro:
			'Poradniki SEO undetected cheatów Enlisted, ESP wallhack, radar hack, Aimbot i Darkflow Software anti-cheat (EAC) w 22 językach.',
	...
	ru: {
		...
		blogIntro:
			'SEO-гайды по undetected читам Enlisted, ESP wallhack, radar hack, Aimbot и Darkflow Software anti-cheat (EAC) на 22 языках.',
	...
	tr: {
		...
		blogIntro:
			'Undetected Enlisted hileleri, ESP wallhack, radar hack, Aimbot ve Darkflow Software anti-cheat (EAC) SEO rehberleri 22 dilde.',
	...
	ar: {
		...
		blogIntro:
			'أدلة SEO لغش Enlisted undetected وESP wallhack ورadar hack وAimbot وDarkflow Software anti-cheat (EAC) بـ 22 لغة.',
	...
	ja: {
		...
		blogIntro:
			'undetected Enlistedチート、ESP wallhack、radar hack、Aimbot、Darkflow Software anti-cheat (EAC)のSEOガイドを22言語で提供。',
		readMore: 'ガイドを読む',
		published: '公開日',
		updated: '更新日',
	...
	ko: {
		...
		blogIntro:
			'undetected Enlisted 치트, ESP wallhack, radar hack, Aimbot, Darkflow Software anti-cheat (EAC) SEO 가이드를 22개 언어로 제공.',
		readMore: '가이드 읽기',
		published: '게시일',
		updated: '업데이트',
	...
	zh: {
		...
		blogIntro:
			'undetected Enlisted作弊、ESP wallhack、radar hack、Aimbot和Darkflow Software anti-cheat (EAC)的SEO指南，共22种语言。',
		readMore: '阅读指南',
		published: '发布',
		updated: '更新',
	...
	hi: {
		...
		blogIntro:
			'undetected Enlisted cheats, ESP wallhack, radar hack, Aimbot और Darkflow Software anti-cheat (EAC) SEO गाइड 22 भाषाओं में।',
		readMore: 'गाइड पढ़ें',
		published: 'प्रकाशित',
		updated: 'अपडेट',
	...
	id: {
		...
		blogIntro:
			'Panduan SEO cheat Enlisted undetected, ESP wallhack, radar hack, Aimbot dan Darkflow Software anti-cheat (EAC) dalam 22 bahasa.',
	...
	th: {
		...
		blogIntro:
			'คู่มือ SEO สำหรับ cheat Enlisted undetected, ESP wallhack, radar hack, Aimbot และ Darkflow Software anti-cheat (EAC) 22 ภาษา',
		readMore: 'อ่านคู่มือ',
		published: 'เผยแพร่',
		updated: 'อัปเดต',
	...
	vi: {
		...
		blogIntro:
			'Hướng dẫn SEO cheat Enlisted undetected, ESP wallhack, radar hack, Aimbot và Darkflow Software anti-cheat (EAC) bằng 22 ngôn ngữ.',
	...
	uk: {
		...
		blogIntro:
			'SEO-гайди з undetected читів Enlisted, ESP wallhack, radar hack, Aimbot та Darkflow Software anti-cheat (EAC) 22 мовами.',
	...
	cs: {
		...
		blogIntro:
			'SEO průvodce undetected Enlisted cheaty, ESP wallhack, radar hack, Aimbot a Darkflow Software anti-cheat (EAC) ve 22 jazycích.',
	...
	ro: {
		...
		blogIntro:
			'Ghiduri SEO cheat-uri Enlisted undetected, ESP wallhack, radar hack, Aimbot și Darkflow Software anti-cheat (EAC) în 22 de limbi.',
	...
	sv: {
		...
		blogIntro:
			'SEO-guider för undetected Enlisted cheats, ESP wallhack, radar hack, Aimbot och Darkflow Software anti-cheat (EAC) på 22 språk.',
		readMore: 'Läs guide',
