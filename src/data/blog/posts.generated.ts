...
export const blogPosts: BlogPostDefinition[] = [
	...
	},
	{
		...
		intro: "Enlisted cheats 2026 searches spike every season. Here is what still matters: maintained ESP wallhack, Aimbot profiles, radar awareness, and rebuilds after Gaijin anti-cheat patches.",
		...
		sections: [
			{
				...
				paragraphs: [
					...
					"Track official messaging on <a href=\"https://enlisted.net/\" target=\"_blank\" rel=\"noopener noreferrer\">official Enlisted patch notes</a>, then confirm product status on <a href=\"/updates/\">Updates</a> and <a href=\"/enlisted-cheats/\">the cheats 2026 landing</a>.",
				],
			},
			{
