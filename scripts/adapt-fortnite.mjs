...
const REPLACEMENTS = [
	...
	['ricochet', 'eac'],
	['Verdansk, Urzikstan, and Rebirth Island', 'Enlisted battles, large-scale battles, and frontline campaigns lobbies'],
	['Verdansk, Urzikstan and Rebirth Island', 'Enlisted battles, large-scale battles and frontline campaigns lobbies'],
	['Verdansk, Urzikstan, et Rebirth Island', 'Enlisted battles, large-scale battles et lobbies compétitifs'],
	['Verdansk, Urzikstan e Rebirth Island', 'Enlisted battles, large-scale battles e lobbies competitivi'],
	['Verdansk, Urzikstan und Rebirth Island', 'Enlisted battles, large-scale battles und frontline campaigns-Lobbys'],
	...
	['Operator', 'Player'],
	['UAV', 'supply drop'],
	['Resurgence and frontline campaigns', 'large-scale battles and frontline campaigns'],
