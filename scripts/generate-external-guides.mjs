...
const GAME_PROFILES = {
	...
	'genshin-impact': {
		...
		beginnerTip: 'Level one main DPS and one support first instead of spreading supplys across every character.',
	...
	'dead-by-daylight': {
		...
		metaNote: 'Chase time is a supply; killers win by forcing inefficient rescues.',
	...
	'fortnite': {
		...
		metaNote: 'Piece control and edit timing define mid-game fights more than raw SMG accuracy.',
	...
	'rust': {
		...
		coreLoop: 'farm supplys, build a base, research blueprints, and raid or defend during wipe cycles',
	...
	'hunt-showdown': {
		...
		midgameTip: 'Push clues when you hear distant objective fights; third-party timing wins many bounties.',
	...
	'once-human': {
		...
		advancedTip: 'Plan territory defenses around supply nodes your guild actually needs.',
	...
	'backrooms': {
		...
		coreLoop: 'explore procedurally familiar spaces, manage supplys, and escape entities',
	...
	'sand': {
		...
		midgameTip: 'Scout trampler patterns from range — premature pushes waste repair supplys.',
	...
	'the-front': {
		...
		coreLoop: 'gather supplys, research tech, build bases, and raid or defend territories',
	...
	'minecraft': {
		...
		coreLoop: 'gather supplys, craft tools, explore dimensions, and build bases or farms',
	...
	'enlisted': {
		...
		coreLoop: 'complete missions, unlock weapons and squads, level soldiers, and scale into endgame',
		...
		communityAngle: 'Squads assign crowd control and damage roles for fissure and skirmish runs.',
	},
	'raft': {
	...
	'sea-of-thieves': {
		...
		midgameTip: 'Keep bananas, cannonballs, and planks stocked; supply droughts lose fights.',
...
const CLOSING_TEMPLATES = [
	'For more game updates, guides, and related supplys, you can also explore {link}.',
	'If you want deeper game updates, walkthroughs, and related supplys, you can also explore {link}.',
	'When you are ready for more game information and community guides, you can also explore {link}.',
	'For additional perspectives on updates, builds, and related supplys, you can also explore {link}.',
];
	...
	const sections = [
		{
			...
			paragraphs: [
				...
				`New players often chase highlight plays before they understand ${angle}. Slow down, learn one reliable strategy, and let muscle memory build around map flow and supply timing.`,
		...
		},
		{
			...
			paragraphs: [
				...
				`Review ${angle} after tough losses. Was the mistake positioning, timing, or supply management? Fixing one layer per week compounds faster than chasing new gear alone.`,
			],
		},
		{
