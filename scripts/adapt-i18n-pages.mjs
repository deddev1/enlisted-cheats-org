...
const REPLACEMENTS = [
	...
	['Operator', 'Player'],
	['UAV', 'supply drop'],
	['Resurgence and frontline campaigns', 'mission objectives and raids'],
	['BR and Resurgence', 'large-scale battles and frontline campaigns'],
...
phrases = phrases.replace(
	...
	game: 'Enlisted',
	checkout: 'Zadeyo',
	eac: 'Darkflow Software anti-cheat (EAC)',
};`,
);
