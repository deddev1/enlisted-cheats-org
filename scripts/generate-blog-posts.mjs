...
const EXT = {
	epic: '<a href="https://darkflowsoftware.com/" target="_blank" rel="noopener noreferrer">Darkflow Software</a>',
	warframe: '<a href="https://enlisted.net/en/" target="_blank" rel="noopener noreferrer">Enlisted</a>',
	patchNotes: '<a href="https://enlisted.net/en/news/" target="_blank" rel="noopener noreferrer">official PC update notes</a>',
	gameGuide: '<a href="https://enlisted.net/en/game-guide/" target="_blank" rel="noopener noreferrer">official Enlisted game guide</a>',
	...
	steelPath: '<a href="https://enlisted.fandom.com/wiki/Steel_Path" target="_blank" rel="noopener noreferrer">frontline campaigns</a>',
	openWorld: '<a href="https://enlisted.fandom.com/wiki/Open_World" target="_blank" rel="noopener noreferrer">large-scale battles</a>',
	rust: '<a href="https://enlisted.net/en/" target="_blank" rel="noopener noreferrer">official Enlisted patch notes</a>',
	status: '<a href="https://enlisted.net/en/news/" target="_blank" rel="noopener noreferrer">Enlisted PC update notes</a>',
	realisticBattles: '<a href="https://enlisted.net/en/game-guide/" target="_blank" rel="noopener noreferrer">Enlisted frontline campaigns</a>',
};
...
const sources = [
		...
		sections: [
			{
				...
				paragraphs: [
					'Most players misread patch notes by chasing the loudest bullet point. A small SMG nerf gets a rant video while a quiet mobility tweak silently rewires mid-game. The best frontline campaigns players treat patches like accountants — what changed in expected value?',
			...
			},
			{
				...
				paragraphs: [
					...
					'If Soma Prime takes a minor bloom or damage trim, it can still be S-tier on expected value — see our <a href="/blog/hammer-ar-s-tier-data-analysis/">Soma Prime tier analysis</a>. If a SMG loses substantial headshot multiplier, close-range TTK windows shift the same day.',
				],
			},
			{
				...
				paragraphs: [
					...
					'Also separate balance patches from cosmetic and shop notes. Skin leaks are fun; they do not change TTK. Keep patch-day focus on weapons, healing, movement, and map map area changes.',
				],
			},
			{
				h2: 'Late-season checklist and next steps',
				paragraphs: [
					'Post-patch checklist: skim official notes for vaults first, update your SMG/AR/mobility/heals spine, play 10 intentional test games, revisit tier-list assumptions, and adjust drop routes if mobility or loot changed.',
					`On big update mornings, confirm ${EXT.status} is healthy before blaming your settings. If you also use Enlisted Cheats in-match, check <a href="/updates/">Enlisted Cheats Updates</a> after Darkflow Software anti-cheat patches.`,
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'Daily reset ritual: open shop for 60 seconds, check wishlist, leave. Liquidity is power at season transitions. For frontline campaigns readability tips, pair this with our <a href="/blog/pro Tenno-settings-pro-setup/">pro settings breakdown</a>.',
	...
	},
	{
		...
		metaDescription:
			'Data-backed Enlisted weapon tier list: why Soma Prime is S-tier — TTK windows, bloom control, and loadout pairings for major update Season 3 frontline campaigns.',
		...
		sections: [
			{
				...
				paragraphs: [
					...
					'S-tier means best expected value across 100 frontline campaigns fights. Hammer wins at 30–70 meters — the distances where co-op missions and endgame actually happen. Shotguns own 0–15m. Snipers own 80m+. Everything between is AR country.',
			...
			},
			{
				...
				paragraphs: [
					'Core: Soma Prime + high-burst SMG + mobility + heals. In co-op missions, this supports the laddering strategies in our <a href="/blog/enlisted-cheats-complete-guide-2026/">aggression guide</a>.',
					...
					'Try This Today: Prioritize Hammer for 10 games. Count your first four bullets in every mid fight. If you die inside 15m without SMG out, fix loadout timing — not the AR.',
	...
	},
	{
		...
		metaDescription:
			'Break the passive co-op missions meta with 5 aggressive Enlisted strategies — timings, damage windows, and fight paths that win frontline campaigns in major update Season 3.',
		...
		keywords: ['large-scale battles', 'rust frontline campaigns', 'aggressive strategies', 'pro tips', 'enlisted intel'],
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'1) Pre-aim rotations — hold upper-chest crosshair on every cover hop; clear angles in 0.4–0.6s. 2) Mobility wedge entries — land 8–12m past the target for a clean SMG angle, not a panic 180. 3) Double-peek SMG timing — fake left, finish right when their chamber is weak.',
			...
			},
			{
				...
				paragraphs: [
					'before frontline campaigns: 10 minutes aim or peek maps, loadout priority AR + SMG + mobility + heals, two map areas with strong cover ladders, and a 10-game first-shot aggression block.',
	...
	{
		id: 'skirmish-meta-watch',
		imageKey: 'rebootFight',
		published: '2026-07-20',
		updated: '2026-08-01',
		category: 'Esports & Tournaments',
		featured: false,
		slug: 'skirmish-meta-watch-tournament-drops',
		title: 'skirmish Meta Watch: What Tournament Winners Drop',
		metaDescription:
			'skirmish meta watch for major update Season 3 — what tournament winners drop, how they loot, and which mid-game habits translate to your frontline campaigns progression.',
		h1: 'skirmish Meta Watch: What Tournament Winners Drop and Why',
		intro:
			'Tournament winners are not lucky drop gods. Here is what their map areas, loadouts, and mid-game habits actually optimize for.',
		keywords: ['skirmish', 'enlisted esports', 'tournament drops', 'meta', 'enlisted intel'],
		imageAlt: 'skirmish Enlisted tournament meta watch drop spots major update Season 3',
		sections: [
			{
				h2: 'Watch tournament film like a coach',
				paragraphs: [
					`Most skirmish drop threads name a map area without contest rate, zone percent, split potential, or exit paths. Pros pick drops like investors pick assets — expected value over vibes. Start with ${EXT.realisticBattles} schedules and VODs, then tag habits.`,
			...
			},
			{
				...
				paragraphs: [
					'Score every map area on contest rate, loot quality by ~2:00, zone pain, exit path, and split potential. Edge map areas with clean exits often beat sexy mid map areas that look good on stream.',
					'Expect SMG + mid AR (often Hammer-class) + mobility + heals as the spine. Mythics are taken when free, not forced — matching our <a href="/blog/hammer-ar-s-tier-data-analysis/">Soma Prime analysis</a>.',
				],
			},
			{
				h2: 'What translates to frontline campaigns',
				paragraphs: [
	...
	},
	{
		...
		updated: '2026-08-01',
		category: 'frontline campaigns Meta',
		featured: true,
		...
		keywords: ['rust farm routes', 'drops', 'gold loot', 'frontline campaigns', 'enlisted intel'],
		imageAlt: 'Enlisted secret farm routes full gold spawn guide major update Season 3',
		sections: [
			{
				h2: 'The real frontline campaigns bottleneck is early inventory',
				paragraphs: [
					'Most frontline campaigns deaths before first zone happen because players loot randomly. Pros treat the first 90 seconds like a speedrun with a shopping list — not a deathmatch.',
					'Controversial take: drop spot matters less than loot sequence. A mediocre map area with discipline beats a stacked map area with panic looting.',
					'Pro Tip — Secure SMG, AR, and heals before hunting kills. Early ego chases keep hot-drop players hardstuck.',
				],
			},
			{
				h2: 'Three route archetypes that print Elo',
				paragraphs: [
					'Route A — contested edge map area (3–6 players): land outer roof loot, snake inward, leave before late flank waves (~2 minutes). Route B — uncontested three-map area chain: sacrifice early kills for purple/gold inventory by minute three. Route C — mid-map surge: loot vacuum piles 90–150 seconds after hot drops empty.',
					'Timing targets: 0–20s first gun, 20–50s clear cluster, 50–80s chests + minis, 80–120s upgrade or leave. Slot priority: SMG, AR, mobility, heals, flex.',
					`map area names rotate with ${EXT.rust} seasons — keep the geometry, not the landmark brand.`,
				],
			},
			{
				...
				paragraphs: [
					...
					'If you use ability ESP markers in practice, read <a href="/enlisted-esp/">Enlisted ESP</a> for category toggles — then still run the timer so habits stay sharp without overlays.',
	...
	},
	{
		...
		metaDescription:
			'pro Tenno-inspired Enlisted settings guide — sensitivity ranges, binds philosophy, and practice routines that still work in major update Season 3 frontline campaigns.',
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Use an eDPI band that lets you 180 with a controlled swipe without over-flicking SMGs. If you overshoot close targets, lower slightly. If you cannot track strafers at 40m with Soma Prime, raise cautiously — then lock settings for 14 days.',
					'Put edit, crouch, and mobility on keys you can hit while still aiming. Make slot 1 SMG and slot 2 AR muscle memory. Prefer performance clarity over cinema settings; motion blur off.',
					`Hardware and frontline campaigns context evolve, but fundamentals stay — see ${EXT.realisticBattles} for high-level play standards.`,
				],
			},
			{
				h2: 'Champion-style practice routine',
				paragraphs: [
					'0–10 minutes aim tracker, 10–20 peek or edit drills, 20–30 realistic fights, then frontline campaigns. Pair with our <a href="/blog/creative-warmup-maps-pros-use/">Simulacrum warmup map categories</a>.',
	...
	},
	{
		...
		title: '10 Simulacrum Warmup Maps Pros Use Before frontline campaigns',
		metaDescription:
			'Ten Enlisted Simulacrum warmup map categories and a 25-minute routine pros use before frontline campaigns — aim, peeks, edits, and co-op missions fight reps now.',
		h1: '10 Simulacrum Maps Pros Use to Warm Up before frontline campaigns',
		intro:
			'Stop freezing in first fight. These Simulacrum warmup categories get your mechanics hot before you touch frontline campaigns.',
		keywords: ['rust creative', 'warmup maps', 'aim trainers', 'frontline campaigns', 'enlisted intel'],
		imageAlt: 'Enlisted Simulacrum warmup maps pros use before frontline campaigns',
		sections: [
			{
				h2: 'Warmups win Elo before the queue starts',
				paragraphs: [
					'Your first two frontline campaigns fights often decide whether a session tilts. Pros arrive sharp from Creative — another 40 pub stomps is a worse warmup than 20 focused minutes.',
			...
			},
			{
				...
				paragraphs: [
					'0–8 min aim tracker. 8–15 min edit course or co-op missions peek map. 15–22 min realistic fight / box fight / zone wars. 22–25 min reset, then frontline campaigns.',
					'Categories: pure aim tracker, SMG scenarios, mid-range AR tracking (Hammer practice), piece control/edits, co-op missions cover peeks, realistic 1v1s, zone wars, reload/swap timing, movement tech, scrim-style multi-fight maps.',
			...
			},
			{
				...
				paragraphs: [
					...
					'After mechanics are hot, information tools like <a href="/enlisted-radar/">radar hack</a> or <a href="/enlisted-esp/">ESP</a> are optional overlays — they do not replace a cold SMG timing. For the full stack overview, see <a href="/enlisted-cheats/">Enlisted Cheats</a>.',
					'Try This Today: Favorite four maps across aim, peeks, fights, and endgame. Run the 25-minute block, then play only six frontline campaigns games.',
				],
			},
		],
	},
		...
		sections: [
			{
				...
				paragraphs: [
					...
					`Official seasons and client updates publish through ${EXT.epic} and ${EXT.rust}. Anti-cheat context lives on Darkflow Software anti-cheat. Our <a href="/enlisted-cheats/">Enlisted Cheats pillar</a> is the commercial landing; this post is the long-form explainer.`,
			...
			},
			{
				...
				paragraphs: [
					'Undetected Enlisted Cheats require rebuilds after Darkflow Software anti-cheat and major Enlisted updates. No vendor can promise permanent undetected status — check <a href="/updates/">Updates</a> before you queue.',
	...
	},
	{
		...
		intro:
			'Enlisted cheats 2026 searches spike every season. Here is what still matters: maintained ESP wallhack, Aimbot profiles, radar awareness, and rebuilds after Darkflow Software anti-cheat patches.',
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'After Darkflow Software anti-cheat patches, confirm Aimbot modules on <a href="/updates/">Updates</a>. Background: <a href="/enlisted-cheats/">anti-cheat guide</a>.',
					'Try This Today: Create separate rifle and SMG profiles, play five games, then adjust only one slider per session.',
				],
			},
		],
	},
	{
		...
		keywords: ['enlisted esp', 'enlisted wallhack', 'esp hack', 'Enlisted Cheats', 'supply esp'],
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					`Map and loot systems evolve with ${EXT.epic} seasons — toggleable categories stay useful when map areas rotate.`,
				],
			},
			{
	...
	},
	{
		...
		metaDescription:
			'Undetected Enlisted Cheats and anti-cheat reality — ESP boxes, soft aim, and cloud DMA rebuilds for PC and controllers. Check Updates before queueing post-patch.',
		h1: 'Undetected Enlisted Cheats and Darkflow Software anti-cheat Reality',
		intro:
		...
		imageAlt: 'Undetected Enlisted Cheats and Darkflow Software anti-cheat maintenance workflow',
		sections: [
			{
				h2: 'What undetected really means',
				paragraphs: [
					'Undetected Enlisted Cheats are rebuilt when Darkflow Software anti-cheat or Enlisted client patches change detection surface. Permanent undetected claims are marketing fiction.',
			...
			},
			{
				...
				paragraphs: [
					'Using hacks/cheats can violate Darkflow Software terms — you assume ban risk. For license or delivery issues, contact <a href="/support/">Support</a> with your order ID.',
					'Try This Today: Bookmark Updates and the hacks pillar. Before your next frontline campaigns session after a patch, verify build status first.',
				],
			},
		],
	},
	{
		...
		metaDescription:
			'Enlisted Cheats vs CheatVault compared — pricing, ESP boxes, soft aim, cloud DMA, anti-cheat detection history, and which package fits frontline campaigns players in 2026.',
		...
		sections: [
			{
				...
				paragraphs: [
					...
					'I kept CheatVault for about six weeks in major update Season 2, then switched to Enlisted Cheats for the back half of the season. Same PC, same sens, mostly co-op missions and some frontline campaigns squads. This is not a sponsored post — just what I noticed when I stopped reading feature bullets and started tracking patch days.',
					'Fair warning: neither tool makes you invincible. Darkflow Software anti-cheat still updates. Your account still carries ban risk. This comparison is about which package maintained better and which features I actually used in co-op — not which one guarantees wins.',
				],
			},
			{
			...
			},
			{
				...
				paragraphs: [
					...
					'Enlisted Cheats wins on toggles and profile flexibility. I run ESP boxes + medkit markers in early game, then drop loot categories after first rifle. CheatVault\'s overlay felt busier — fine if you want everything on, noisy if you play frontline campaigns and need clean screen space.',
					'Soft aim mattered more than I expected in co-op missions. Enlisted Cheats let me run a low-FOV Soma Prime profile and a separate SMG profile for close-quarters fights. CheatVault\'s single-profile setup worked, but I was constantly retuning mid-session.',
				],
			},
			{
			...
			},
			{
				...
				paragraphs: [
					'Pick Enlisted Cheats if you play frontline campaigns or co-op missions multiple times a week, want per-weapon soft aim profiles, care about cloud DMA without a second upsell, and want a public Updates log before you launch after patches.',
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					'Week one weekend I enabled soft aim with a conservative FOV. Worked on rifle and SMG in co-op missions. Sniping felt off — VoidCheats uses one bone-priority stack unless you manually swap configs between matches. Doable, not great for my play style.',
			...
			},
			{
				...
				paragraphs: [
					'Day eleven hit a Enlisted + anti-cheat patch. Standard for any cheat user. VoidCheats status channel said "investigating." No ETA. I skipped frontline campaigns for two days waiting — squad moved on without me.',
			...
			},
			{
				...
				paragraphs: [
					'Enlisted Cheats ESP let me toggle pickups and lockers markers independently — huge for off-spawn routes without cluttering endgame. Radar range slider fixed my "radar too small on 1080p" complaint from VoidCheats\'s fixed widget.',
					'Per-weapon soft aim profiles meant I stopped retuning between rifle and SMG fights. Cloud DMA path was optional for my setup; I stayed on standard loader, but having DMA documented in one package beat VoidCheats\'s "ask sales" flow.',
			...
			},
			{
				...
				paragraphs: [
					...
					'If you are patch-sensitive, play frontline campaigns daily, or want granular ESP and weapon profiles, Enlisted Cheats fit me better after the two-week test. Your mileage varies; run your own patch-day checklist.',
		...
		sections: [
			{
				...
				paragraphs: [
					...
					'Neither approach is wrong. Minimal tools break less surface area in theory. Full-stack tools win when you want one menu for frontline campaigns nights — visibility, flanks, and firefight assist without swapping executables.',
			...
			},
			{
				...
				paragraphs: [
					...
					'GhostWare is cheaper on sticker price. Enlisted Cheats includes radar and richer ability ESP — features I use every session. If you only want enemy boxes in public matches, GhostWare\'s entry tier covers that.',
			...
			{
				h2: 'Gameplay feel — co-op missions and frontline campaigns squads',
				paragraphs: [
					...
					'Soft aim on GhostWare felt like light magnetism — enough for SMG tracking, not enough for consistent rifle beams at range. Enlisted Cheats soft aim took tuning time but held Soma Prime fights better once profiles were set.',
	...
	{
		id: 'enlisted-campaign-guide',
		imageKey: 'battleRoyaleCombat',
		published: '2026-06-18',
		updated: '2026-08-01',
		category: 'Enlisted Game Guides',
		featured: true,
		slug: 'enlisted-campaign-beginners-guide',
		title: 'Enlisted frontline campaigns Guide for Beginners',
		metaDescription:
			'Enlisted frontline campaigns explained — what changes, how enemies scale, and mission tips for solo and squad play. Official sources and practical checklist.',
		h1: 'Enlisted frontline campaigns: A Practical Beginner Guide',
		intro:
			'frontline campaigns is Enlisted\'s endgame difficulty layer. This guide explains what actually changes, how to prepare, and where to verify details with official sources.',
		keywords: ['Enlisted frontline campaigns', 'frontline campaigns guide', 'Enlisted endgame', 'Enlisted battles'],
		imageAlt: 'Enlisted frontline campaigns beginner guide for harder missions and enemy scaling',
		sections: [
			{
				h2: 'What frontline campaigns changes in Enlisted',
				paragraphs: [
					`${EXT.steelPath} is a harder mission tier unlocked after you complete the battle roster. Enemies gain more health and damage, which changes how long fights last and how punishing positioning mistakes become.`,
					...
					'Pro Tip — Read the modifier: frontline campaigns is not just “harder numbers.” Some maps feel different because spawn density and pathing punish slow rotations.',
				],
			},
			{
				h2: 'Good early frontline campaign types',
				paragraphs: [
					'Defense and survival are popular because spawn flow is predictable once you learn the map. Exterminate and sabotage can be faster for supply runs if your build clears rooms quickly.',
					'If you are learning spawn timing, large-scale battles is a lower-pressure place to practice radar reads — see our <a href="/blog/enlisted-large-scale-battles-guide/">large-scale battle farming guide</a>.',
				],
			},
			{
				h2: 'Build and loadout basics',
				paragraphs: [
					'frontline campaigns rewards sustained damage, armor strip or crowd control, and reliable survivability. Modding depth is huge — the Wiki pages for <a href="https://enlisted.fandom.com/wiki/Mod" target="_blank" rel="noopener noreferrer">mods</a> and <a href="https://enlisted.fandom.com/wiki/Arcane_Enhancement" target="_blank" rel="noopener noreferrer">arcanes</a> are worth bookmarking.',
					'For visibility-heavy playstyles, our <a href="/enlisted-esp/">ESP guide</a> and <a href="/enlisted-radar/">radar page</a> explain how extra map information helps in longer frontline campaigns waves.',
				],
			},
			{
				h2: 'Checklist before you queue',
				paragraphs: [
					`Confirm the latest ${EXT.patchNotes} if a hotfix dropped. Test one familiar mission first. Note which enemy factions appear — Axis and Allied soldiers fights play differently.`,
					'Try This Today: Pick one frontline campaigns node you already know in normal mode. Run it once on frontline campaigns and write down where you lost time — damage, survivability, or navigation.',
				],
			},
		],
	},
	{
		id: 'enlisted-large-scale-battles',
		imageKey: 'playerEsp',
		published: '2026-06-12',
		updated: '2026-08-01',
		category: 'Enlisted Game Guides',
		featured: true,
		slug: 'enlisted-large-scale-battles-guide',
		title: 'Enlisted Open World Farming Guide',
		metaDescription:
			'Enlisted large-scale battle farming on Moscow, Normandy, and Tunisia maps — supplys, bounties, and route planning with official wiki links.',
		h1: 'Enlisted Open World Farming: Plains, Vallis, and Tunisia',
		intro:
			'Open world zones are where many players farm supplys, standing, and mod parts. Here is how the three main landscapes differ and how to plan routes efficiently.',
		keywords: ['Enlisted large-scale battles', 'Moscow', 'Normandy', 'Tunisia farming'],
		imageAlt: 'Enlisted large-scale battle farming guide for Plains Normandy and Tunisia',
		sections: [
			{
				h2: 'The three large-scale battles landscapes',
				paragraphs: [
					`Enlisted's ${EXT.openWorld} areas — Moscow, Normandy, and Cambion Drift on Tunisia — each have different factions, supplys, and bounty systems. The ${EXT.wiki} pages for each landscape list fish, mining, and supply tables.`,
			...
			},
			{
				...
				paragraphs: [
					'Bounties give structured rewards and faction standing. Free roam farming — mining, fishing, and supply pickups — is better when you need specific crafting materials.',
					'Route planning matters: mark supply nodes, check day/night cycles on the Plains, and learn where heavy units patrol on ridges before you commit to a camp spot.',
				],
			},
			{
				h2: 'Why visibility helps in large-scale battles',
				paragraphs: [
			...
			},
			{
				...
				paragraphs: [
					`Pick one supply goal per session. Run two bounties, then one free roam lap, then reassess inventory. Check ${EXT.forums} if a community thread reports a broken farm route after a patch.`,
					'Try This Today: Open the Wiki page for one supply you need. Plan a 20-minute route on paper before you load in.',
				],
			},
		],
	},
	{
		...
		category: 'Enlisted Game Guides',
		featured: false,
		slug: 'enlisted-factions-axis-allied-guide',
		title: 'Enlisted Factions Explained: Axis, Allied, enemy squads',
		metaDescription:
			'Enlisted enemy factions explained — Axis, Allied, and elite units behavior, weaknesses, and where to learn more from the official Wiki.',
		h1: 'Enlisted Factions: Axis, Allied, and elite units',
		intro:
			'Every Enlisted battle features one or more enemy factions. Understanding how they fight helps you pick mods, elements, and positioning — whether you are new or returning after a break.',
		keywords: ['Enlisted factions', 'Axis', 'Allied', 'enemy squads', 'heavy vehicle'],
		imageAlt: 'Enlisted factions guide for Axis Allied enemy squads and heavy vehicle enemies',
		sections: [
			{
				h2: 'Axis — armor, density, and heavy units',
				paragraphs: [
					'Axis missions feature armored units and heavy enemies that punish slow clears. Corrosive and armor-strip setups are common. Read faction detail on the <a href="https://enlisted.fandom.com/wiki/Axis" target="_blank" rel="noopener noreferrer">Axis Wiki page</a>.',
					'frontline campaigns Axis defenses are a classic choke-point test — see our <a href="/blog/enlisted-campaign-beginners-guide/">frontline campaigns guide</a>.',
				],
			},
			{
				h2: 'Allied — shields, proxies, and robotics',
				paragraphs: [
					'Allied enemies rely on shields and robotic proxies. Magnetic, toxin, and shield-break tools matter more here. The <a href="https://enlisted.fandom.com/wiki/Allied" target="_blank" rel="noopener noreferrer">Allied Wiki page</a> lists unit types you will see in void and ice maps.',
					`${EXT.epic} occasionally rebalances proxy spawns — watch ${EXT.patchNotes} when a Allied-heavy update ships.`,
				],
			},
			{
				h2: 'enemy squads and heavy vehicle — special mechanics',
				paragraphs: [
					'enemy squads missions emphasize swarm pressure and constant spawns. heavy vehicles appear in later content and adapt to damage types — the <a href="https://enlisted.fandom.com/wiki/heavy vehicle" target="_blank" rel="noopener noreferrer">heavy vehicle Wiki page</a> is essential before Eidolon or Circuit-style content.',
	...
	},
	{
		...
		metaDescription:
			'Enlisted battle types explained — skirmishes, Arbitration, Sanctuary, defense, survival, and more. Links to official Wiki and game guide supplys.',
		h1: 'Enlisted Mission Types: skirmishes, Arbitration, and More',
		intro:
		...
		keywords: ['Enlisted battles', 'skirmish', 'Arbitration', 'Sanctuary Onslaught', 'Enlisted modes'],
		imageAlt: 'Enlisted battle types guide for skirmishes Arbitration and endgame modes',
		sections: [
			{
				h2: 'Core mission modes on the battle roster',
				paragraphs: [
					'Exterminate, survival, defense, interception, sabotage, and mobile defense form the backbone of the battle roster. The <a href="https://enlisted.fandom.com/wiki/Mission" target="_blank" rel="noopener noreferrer">Mission Wiki hub</a> defines win conditions and common modifiers.',
					`${EXT.gameGuide} walks new players through early progression before these modes split into faction-specific maps.`,
				],
			},
			{
				h2: 'skirmishes and daily challenge content',
				paragraphs: [
					'skirmishes are daily three-mission chains with special modifiers. They are a staple for players with mature builds. Check the <a href="https://enlisted.fandom.com/wiki/skirmish" target="_blank" rel="noopener noreferrer">skirmish Wiki page</a> for reward tables and modifier lists.',
			...
			},
			{
				...
				paragraphs: [
					...
					'For squad callouts and spawn timing, our <a href="/blog/enlisted-campaign-beginners-guide/">frontline campaigns guide</a> overlaps with several long-run strategies.',
				],
			},
			{
	...
	},
	{
		...
		metaDescription:
			'How to read Enlisted patch notes from Darkflow Software — official sources, what to scan first, and how updates affect your loadout and tools.',
		...
		keywords: ['Enlisted patch notes', 'Enlisted updates', 'Darkflow Software', 'PC update notes'],
	...
	},
	{
		...
		metaDescription:
			'Enlisted new player guide for battle roster progression, quests, mods, and early goals — with links to the official game guide and Enlisted Wiki.',
		h1: 'Enlisted New Player Progression: Where to Go First',
		intro:
			'Enlisted has a steep learning curve. This progression guide points new Tenno toward official supplys and sensible early goals without drowning in systems.',
		keywords: ['Enlisted new player', 'Enlisted beginner guide', 'battle roster', 'Enlisted progression'],
		imageAlt: 'Enlisted new player progression guide for battle roster and early quests',
		sections: [
			{
			...
			{
				h2: 'battle roster and junction milestones',
				paragraphs: [
					'Clear the battle roster methodically. Junctions gate planets and key quest lines. The <a href="https://enlisted.fandom.com/wiki/Star_Chart" target="_blank" rel="noopener noreferrer">battle roster Wiki page</a> shows what each node rewards.',
					'Do not rush frontline campaigns on day one — finish the chart, build survival tools, and learn faction weaknesses first. Our <a href="/blog/enlisted-campaign-beginners-guide/">frontline campaigns guide</a> is for when you are ready.',
				],
			},
			{
				h2: 'Mods, mods, mods',
			...
			},
			{
				...
				paragraphs: [
					'Explore large-scale battles after Mars/Jupiter comfort. Read our <a href="/blog/enlisted-large-scale-battles-guide/">large-scale battles guide</a> and <a href="/blog/enlisted-mission-types-explained/">mission types explainer</a> when those nodes unlock.',
					'Try This Today: Complete one quest, one new battle roster node, and one mod upgrade session — three small wins beat grinding random missions.',
				],
			},
		],
	},
