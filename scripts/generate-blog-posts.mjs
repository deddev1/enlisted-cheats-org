...
const sources = [
	...
	},
	{
		...
		metaDescription:
			'Enlisted Cheats vs CheatVault compared — pricing, ESP boxes, soft aim, cloud DMA, anti-cheat detection history, and which package fits campaign missions players in 2026.',
