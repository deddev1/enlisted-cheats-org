...
const KW = {
	...
	game: 'Enlisted',
	checkout: 'Zadeyo',
	eac: 'Darkflow Software anti-cheat',
};
...
export const phrases = {
	es: {
		buy: 'Obtener acceso', undetected: 'indetectables', maps: 'frontline campaigns, skirmishes y mundo abierto',
		...
		legal: () => 'Contacta support@enlistedcheats.org para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Obtenir l\'accès', undetected: 'indétectables', maps: 'frontline campaigns, skirmishes et monde ouvert',
		...
		legal: () => 'Contactez support@enlistedcheats.org pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Zugang erhalten', undetected: 'unentdeckt', maps: 'frontline campaigns, skirmishes und Open World',
		...
		legal: () => 'support@enlistedcheats.org für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Enlisted Cheats', undetected: 'indetectáveis', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => 'Contacte support@enlistedcheats.org para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Enlisted Cheats', undetected: 'indetectable', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => 'Contatta support@enlistedcheats.org per supporto o richieste legali.',
	},
	nl: {
		buy: 'Enlisted Cheats kopen', undetected: 'undetected', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => 'support@enlistedcheats.org voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Enlisted Cheats', undetected: 'undetected', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => 'support@enlistedcheats.org w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Enlisted Cheats', undetected: 'undetected', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => 'support@enlistedcheats.org для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Enlisted Cheats satın al', undetected: 'undetected', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => 'Destek ve yasal sorular için support@enlistedcheats.org.',
	},
	ar: {
		buy: 'اشترِ Enlisted Cheats', undetected: 'غير مكتشف', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => 'support@enlistedcheats.org للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Enlisted Cheatsを購入', undetected: 'undetected', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => 'サポート・法務: support@enlistedcheats.org',
	},
	ko: {
		buy: 'Enlisted Cheats 구매', undetected: 'undetected', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => '지원 및 법무: support@enlistedcheats.org',
	},
	zh: {
		buy: '购买 Enlisted Cheats', undetected: 'undetected', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => '支持与法务：support@enlistedcheats.org',
	},
	hi: {
		buy: 'Enlisted Cheats खरीदें', undetected: 'undetected', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => 'सहायता: support@enlistedcheats.org',
	},
	id: {
		buy: 'Beli Enlisted Cheats', undetected: 'undetected', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => 'support@enlistedcheats.org untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Enlisted Cheats', undetected: 'undetected', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => 'support@enlistedcheats.org สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Enlisted Cheats', undetected: 'undetected', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => 'support@enlistedcheats.org cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Enlisted Cheats', undetected: 'undetected', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => 'support@enlistedcheats.org для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Enlisted Cheats', undetected: 'undetected', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => 'support@enlistedcheats.org pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Enlisted Cheats', undetected: 'undetected', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => 'support@enlistedcheats.org pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Enlisted Cheats', undetected: 'undetected', maps: 'mission objectives, spawn routes, and mission objectives',
		...
		legal: () => 'support@enlistedcheats.org för support och juridik.',
	},
};
