...
export const enPages = {
	home: {
		...
		h1: 'Enlisted Cheats',
		intro:
			'A focused Windows PC package for Enlisted: Enemy ESP, aimbot controls, and wallhack overlays with Darkflow Software anti-cheat maintenance after major patches.',
		...
		sections: [
			section(
				'Built for frontline campaigns pressure',
			...
			section(
				...
				'Instead of stacking separate tools, you get Enemy ESP, medkit markers, radar cues, and aimbot profiles in a single package aimed at large-scale battles and frontline campaigns.',
	...
	'enlisted-esp': {
		...
		intro:
			'Visibility tools for Enlisted. Read enemy units, lockers, supply caches, and pickups, and distance before you commit to a fight — with toggleable ESP wallhack overlays for large-scale battles and frontline campaigns.',
		...
		sections: [
			section(
				'What Enlisted ESP solves in frontline campaigns',
				'Enlisted battles punish incomplete information. Enlisted Cheats ESP wallhack helps you spot enemy units early, spot heavy units before they push your position, and mark lockers and caches worth the detour.',
				'On frontline campaigns, co-op missions, and frontline campaigns, that visibility gap is often the difference between a clean flanking and a wiped squad. ESP ships bundled with radar overlays and Aimbot in one license.',
				`Enlisted live updates and map changes are published by ${EXT.epic}. When map areas or loot rules shift, ESP categories stay useful because they track enemies and containers — not a single static landmark.`,
			),
			section(
			...
			section(
				...
				'Enlisted Cheats ESP wallhack is maintained for Enlisted with rebuilds after Darkflow Software anti-cheat patches. Check the <a href="/updates/">Updates page</a> before you queue — no cheat guarantees permanent undetected status.',
	...
	'enlisted-aimbot': {
		...
		description:
			'Enlisted aimbot with FOV, smoothing & weak-point targeting. Per-weapon profiles for rifles, SMGs & snipers. Windows PC.',
		...
		sections: [
			section(
				...
				'Enlisted mixes long-range rifle fights with close-quarters SMG pushes. Enlisted Cheats Aimbot includes smoothness, FOV, and sensitivity controls tuned for that pace — with hotkey toggles mid-mission.',
				'Bone priority and target selection options cover closest enemy, lowest health, or highest-threat targets during squad fights and defense waves and skirmish modifiers.',
			...
			section(
				...
				'Save separate Aimbot profiles for rifles, SMGs, and snipers. Switch between long-range rifle beams and close-quarters room clears without reopening menus every spawn.',
				...
				[
					...
					'Per-weapon profile slots for rifle/ SMG / sniper',
				],
			),
			section(
				'anti-cheat maintenance for undetected Aimbot',
				'Enlisted Cheats rebuilds Aimbot behavior when Darkflow Software anti-cheat or major Enlisted patches land. Maintenance notes appear on the <a href="/updates/">Updates page</a> so you know when a new build is live.',
	...
	features: {
		...
		sections: [
			section(
				...
				'Team and enemy colour coding supports co-op missions and frontline campaigns. Deep-dive the <a href="/enlisted-esp/">ESP page</a> and <a href="/enlisted-wallhack/">wallhack guide</a> for category-level detail.',
				`Map and loot systems evolve with ${EXT.epic} season updates — toggleable ESP categories keep overlays useful when map areas rotate.`,
			),
			section(
	...
	pricing: {
		...
		imageAlt: 'Enlisted wallhack ESP showing enemy units and heavy vehicles through objective corners',
		...
		sections: [
			...
			section(
				...
				'enemy ESP wallhack, medkit markers, 2D radar overlays, Aimbot controls, in-client toggles, and maintenance rebuilds after Darkflow Software anti-cheat or major Enlisted patches.',
	...
	setup: {
		...
		imageAlt: 'Enlisted aimbot hitbox lock on enemy unit during frontline campaign fight',
		...
		sections: [
			...
			section(
				'After Enlisted or Darkflow Software anti-cheat patches',
				'When Darkflow Software ships a major Enlisted update or Darkflow Software anti-cheat patch, revisit Updates before queueing. Download maintenance rebuilds when posted.',
	...
	updates: {
		...
		imageAlt: 'Enlisted wallhack ESP skeleton on enemy heavy unit hero in frontline campaigns',
		...
		sections: [
			section(
				...
				'Enlisted and Darkflow Software anti-cheat receive frequent patches. Enlisted Cheats publishes maintenance notes when ESP wallhack, radar, or Aimbot behavior needs a rebuild.',
				...
				'Checking this log before you queue reduces surprises after game days or seasonal launches on frontline campaigns and co-op missions.',
			),
			section(
				'What maintenance entries cover',
				'Entries note Darkflow Software anti-cheat compatibility status, rebuilt ESP wallhack overlays, radar range fixes, Aimbot tuning after weapon balance changes, and digital delivery of new builds to active licenses.',
			...
			section(
				...
				`Follow patch notes from ${EXT.rust}, then confirm our rebuild is live before frontline campaigns.`,
	...
	faq: {
		...
		imageAlt: 'Enlisted radar hack 2D minimap overlay showing spawn routes and enemy units and heavy vehicles',
		...
		sections: [
			section(
				...
				'Packages cover frontline campaigns and co-op missions. Explore <a href="/features/">Features</a> for the full control list and <a href="/enlisted-esp/">ESP</a> / <a href="/enlisted-aimbot/">Aimbot</a> for module detail.',
				`Enlisted is developed and published by ${EXT.epic}. Cheats are third-party tools and may violate Darkflow Software' Terms of Service — use is at your own risk.`,
			),
			section(
				'Are Enlisted Cheats undetected in 2026?',
				'Enlisted Cheats is maintained with rebuilds after Darkflow Software anti-cheat and game patches. Check the <a href="/updates/">Updates page</a> for current status — no cheat can guarantee permanent undetected operation.',
	...
	support: {
		...
		imageAlt: 'Enlisted cheats frontline campaigns objective fight with ESP boxes and aimbot active',
		galleryTitle: 'Enlisted Cheats support supplys',
		...
		sections: [
			...
			section(
				...
				'Support requests are reviewed daily. Enlisted Cheats support covers delivery, billing, setup, and maintenance — not in-game coaching or account recovery for Darkflow Software bans.',
			...
			section(
				'Self-service supplys',
				'Setup guide, Features list, Updates log, Refund Policy, and Terms of Use are linked from the footer. anti-cheat maintenance notes live on the dedicated <a href="/enlisted-cheats/">Darkflow Software anti-cheat page</a>.',
	...
	undetected: {
		...
		intro:
			'How Enlisted Cheats stays maintained for Enlisted after Darkflow Software anti-cheat patches — ESP wallhack, radar hack, and Aimbot rebuilds for Windows PC.',
		imageAlt: 'Enlisted wallhack ESP skeleton boxes on enemy units and heavy vehicles through map geometry',
		...
		sections: [
			section(
				...
				'Undetected Enlisted Cheats means the package is actively maintained against Darkflow Software anti-cheat and major Enlisted patches — not that detection is impossible forever.',
				'Rebuilds target ESP wallhack overlays, radar behavior, and Aimbot signatures after Darkflow Software anti-cheat updates.',
			...
			section(
				...
				'When Darkflow Software anti-cheat or Enlisted updates ship, the team assesses ESP, radar, and Aimbot modules, publishes status on the <a href="/updates/">Updates page</a>, and delivers rebuilt builds to active licenses.',
	...
	wallhack: {
		...
		description:
			'Enlisted wallhack ESP highlights Axis, Allied & enemy squads through cover. Toggle categories for frontline campaigns & large-scale battles.',
		h1: 'Enlisted Wallhack — ESP Boxes & Visibility',
		intro:
			'Enlisted wallhack ESP for Enlisted — see enemies, pickups, and lockers through toggleable wallhack overlays built for large-scale battles and frontline campaigns.',
		imageAlt: 'Enlisted wallhack ESP skeleton boxes on enemy unit hero in frontline campaigns',
		...
		sections: [
			section(
				...
				'A Enlisted wallhack focuses on information — enemy outlines, loot pins, heavy unit threat cues — rather than automatic aiming. Enlisted Cheats bundles wallhack ESP with radar and optional Aimbot in one license.',
			...
			section(
				...
				'Wallhack overlays support frontline campaigns, co-op missions, and frontline campaigns with distance readouts and snaplines for engagement control.',
				`map updates and map area changes are announced via ${EXT.rust}. Wallhack remains useful because it tracks entities, not fixed landmarks alone.`,
			...
			section(
				...
				'ESP wallhack modules rebuild after Darkflow Software anti-cheat patches. Follow the <a href="/updates/">Updates page</a> and complete checkout for instant license delivery on Windows PC.',
	...
	radar: {
		...
		imageAlt: 'Enlisted ESP distance markers and hero health readouts in frontline campaigns',
		...
		sections: [
			...
			section(
				...
				'Adjust radar range for early rotations versus tight defense waves. Directional cues highlight flanks during map clears and heavy unit pushes across frontline campaigns and co-op missions.',
	...
	'eac-bypass': {
		...
		description:
			'How Enlisted Cheats rebuild after Darkflow Software anti-cheat patches — ESP, aimbot & radar maintenance for PC. Read before queueing.',
		h1: 'Enlisted Anti-Cheat — Maintenance Guide',
		intro:
			'Understand Darkflow Software anti-cheat maintenance for Enlisted Cheats — how ESP wallhack, radar hack, and Aimbot rebuild after Enlisted security updates.',
		imageAlt: 'Enlisted undetected hacks status with ESP overlay on enemy units and heavy vehicles',
		...
		sections: [
			section(
				'Darkflow Software anti-cheat overview',
				`Darkflow Software anti-cheat is Darkflow Software’ anti-cheat for Enlisted on PC (see ${EXT.eac}). Security updates can affect ESP wallhack, radar, and Aimbot behavior — requiring maintenance rebuilds for undetected packages.`,
	...
	'cheats-2026': {
		...
		sections: [
			section(
				...
				'2026 seasons bring new maps, weapons, and Darkflow Software anti-cheat updates. Enlisted Cheats bundles ESP wallhack, radar hack, and Aimbot with active maintenance — not a stale prior-year build.',
				`Track official official patch messaging on ${EXT.rust}, then use our <a href="/updates/">Updates log</a> for product rebuild timing.`,
				'Monthly ($35) and lifetime ($150) plans cover frontline campaigns and co-op missions loops — see <a href="/pricing/">Pricing</a>.',
			),
			section(
	...
	hacks: {
		...
		intro:
			'Enlisted cheats and hacks for campaigns, skirmishes, and large-scale battles combine ESP wallhack visibility, 2D radar threat cues, and aimbot controls in one Windows PC license — maintained after Darkflow Software anti-cheat patches. This is the pillar guide for Enlisted Cheats in 2026.',
		imageAlt: 'Enlisted cheats frontline campaigns objective fight with ESP boxes and aimbot active',
		...
		sections: [
			section(
				...
				'Coverage spans frontline campaigns and co-op missions with in-client toggles for live missions. Monthly ($35) and lifetime ($150) licenses unlock the full stack.',
			...
			section(
				...
				'Standalone hacks often cover only wallhack or only aim assist. Enlisted Cheats maps the full mission loop: read enemy units, track lockers and supply caches, spot flanks on radar, and tune Aimbot per weapon class.',
			...
			section(
				...
				'Undetected Enlisted Cheats require rebuilds after Darkflow Software anti-cheat and major Enlisted patches. Check Updates before queueing — maintenance notes confirm when a new build is live. No package can promise permanent undetected status.',
	...
	'cheat-download': {
		...
		sections: [
			...
			section(
				...
				'Every Enlisted cheat download includes enemy ESP wallhack, pickups and lockers markers, 2D radar overlays, Aimbot profiles, and in-client toggles for large-scale battles and frontline campaigns.',
			...
			section(
				...
				'Follow Setup to activate ESP wallhack and Aimbot on Windows 10 or 11. When Enlisted or Darkflow Software anti-cheat patches ship, check the <a href="/updates/">Updates page</a> for maintenance rebuilds.',
	...
	'mod-menu': {
		...
		sections: [
			section(
				...
				'Toggle enemy outlines, medkit markers, heavy unit cues, and per-weapon Aimbot settings without alt-tabbing out of Enlisted.',
				'Control deep-dives: <a href="/enlisted-esp/">ESP</a>, <a href="/enlisted-aimbot/">Aimbot</a>, <a href="/enlisted-radar/">radar</a>.',
			),
			section(
				'Mod menu categories for large-scale battles and frontline campaigns',
			...
			section(
				...
				'Enlisted mod menu behavior is rebuilt when Darkflow Software anti-cheat or major Enlisted updates land. Follow the <a href="/updates/">Updates page</a> and <a href="/enlisted-cheats/">anti-cheat maintenance guide</a> before queueing on patch days.',
	...
	'soft-aim': {
		...
		imageAlt: 'Enlisted aimbot ESP boxes and FOV circle on enemy units and heavy vehicles in large-scale battles',
		...
		sections: [
			...
			section(
				...
				'Save separate soft aim profiles for rifles, SMGs, and snipers. Switch between long-range rifle beams and close-quarters room clears with hotkeys mid-mission.',
			...
			section(
				...
				'Aimbot modules rebuild after Darkflow Software anti-cheat patches. Check the <a href="/updates/">Updates page</a> before queueing — responsible settings and maintenance awareness matter for undetected play.',
	...
	'best-cheats': {
		...
		intro:
			'Compare the best Enlisted cheats for Enlisted in 2026 — undetected ESP wallhack, radar hack, and Aimbot in one maintained package with Darkflow Software anti-cheat rebuilds and instant delivery.',
		imageAlt: 'Enlisted wallhack ESP showing enemy units and heavy vehicles through objective corners',
		...
		sections: [
			section(
				...
				'Enlisted Cheats covers frontline campaigns and co-op missions with in-client toggles and post-patch rebuilds.',
			...
			section(
				...
				`Remember: using cheats can violate Darkflow Software terms. Proceed only if you accept that risk.`,
			),
		],
	},
	'aimbot-hack': {
		...
		sections: [
			section(
				...
				'Smoothness, FOV, and sensitivity controls tune assist for Enlisted combat pace across large-scale battles and frontline campaigns.',
			...
			section(
				...
				'Per-weapon profile slots separate long-range rifle tuning from close-quarters SMG settings.',
				`Balance patches from ${EXT.rust} can change ideal FOV — retune after major weapon updates.`,
			),
			section(
				'Undetected aimbot hack maintenance',
				'Aimbot hack signatures rebuild after Darkflow Software anti-cheat updates. Follow the <a href="/updates/">Updates page</a> and <a href="/enlisted-cheats/">anti-cheat maintenance guide</a> before queueing after patch days.',
	...
	'esp-hack': {
		...
		intro:
			'Enlisted ESP hack overlays for Enlisted — enemy outlines, heavy unit threat cues, pickups and lockers markers with distance readouts across frontline campaigns and co-op missions.',
		...
		sections: [
			section(
				...
				'A Enlisted ESP hack renders enemy unit outlines, heavy unit positions, and loot pins through walls and terrain — closing the information gap before you commit to a fight.',
			...
			section(
				'ESP hack categories for frontline campaigns',
				'Toggle Enemy ESP hack, medkit markers, chest pins, and heavy unit cues independently so only mission-critical overlays stay active during rotations.',
				'Team and enemy colour coding supports co-op missions and frontline campaigns.',
				`map area and loot changes publish through ${EXT.epic} — keep categories toggled to what the current map rewards.`,
			),
			section(
				'Undetected ESP hack with anti-cheat maintenance',
				'ESP hack modules rebuild after Darkflow Software anti-cheat and Enlisted patches. Check the <a href="/updates/">Updates page</a> before queueing — pair ESP hack awareness with <a href="/enlisted-radar/">radar hack</a> for flank reads.',
	...
	'unlock-all': {
		...
		imageAlt: 'Enlisted ESP boxes and distances on enemy units and heavy vehicles in frontline campaign',
		...
		sections: [
			...
			section(
				...
				'ESP wallhack helps you spot enemy units, lockers, and supply caches during live missions. Radar hack adds flank awareness; Aimbot covers combat assist with smoothness and hotkey controls.',
			...
			section(
				...
				'Check the <a href="/updates/">Updates page</a> after Darkflow Software anti-cheat patches — maintenance rebuilds publish for active licenses.',
	...
	privacy: {
		...
		galleryTitle: 'Enlisted Cheats legal supplys',
		ctaPrimary: 'Email support',
	...
	refund: {
		...
		galleryTitle: 'Enlisted Cheats billing supplys',
	...
	terms: {
		...
		sections: [
			...
			section(
				...
				`Using cheats in Enlisted may violate Darkflow Software terms and result in account penalties. Enlisted Cheats provides maintenance but does not guarantee undetected status or account safety.`,
