...
const PAGE_META_HOME = {
	es: { title: 'Enlisted Cheats 2026 | ESP, Wallhack y Aimbot', desc: 'Trucos Enlisted indetectables para Enlisted en PC. ESP wallhack, radar hack y Aimbot con mantenimiento Gaijin anti-cheat. Entrega digital instantánea.', h1: 'Enlisted Cheats — ESP, Wallhack y Aimbot indetectables', intro: 'Paquete undetected para Enlisted en Windows PC: ESP wallhack, radar y Aimbot con mantenimiento Gaijin anti-cheat tras cada parche.', imageAlt: 'Hero enlisted-cheats con ESP wallhack y Aimbot indetectables', gallery: 'Galería Enlisted Cheats — ESP, Aimbot y wallhack', cta2: 'Ver funciones', h2a: 'Por qué eligen Enlisted Cheats en 2026', h2b: 'ESP wallhack, radar y Aimbot en una licencia', topicA: 'Ideal para leer escuadrones enemigos en misiones y co-op missions.', topicB: 'Una licencia en lugar de herramientas separadas.' },
	fr: { title: 'Enlisted Cheats 2026 | ESP, Wallhack et Aimbot', desc: 'Triches Enlisted indétectables pour Enlisted sur PC. ESP wallhack, radar hack et Aimbot avec maintenance Gaijin anti-cheat. Livraison numérique instantanée.', h1: 'Enlisted Cheats — ESP, Wallhack et Aimbot indétectables', intro: 'Pack undetected pour Enlisted sur PC Windows : ESP wallhack, radar et Aimbot avec maintenance Gaijin anti-cheat après chaque patch.', imageAlt: 'Hero enlisted-cheats avec ESP wallhack et Aimbot indétectables', gallery: 'Galerie Enlisted Cheats — ESP, Aimbot et wallhack', cta2: 'Voir les fonctions', h2a: 'Pourquoi choisir Enlisted Cheats en 2026', h2b: 'ESP wallhack, radar et Aimbot en une licence', topicA: 'Idéal pour repérer les escouades ennemies en campaign missions, squad assaults et missions en coop.', topicB: 'Une licence au lieu d\'outils séparés.' },
	de: { title: 'Enlisted Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected Enlisted Cheats für Enlisted auf PC. ESP Wallhack, Radar Hack und Aimbot mit Gaijin anti-cheat-Wartung. Sofortige digitale Lieferung.', h1: 'Enlisted Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Undetected Windows PC Paket für Enlisted: ESP Wallhack, Radar und Aimbot mit Gaijin anti-cheat-Wartung nach jedem Patch.', imageAlt: 'Enlisted-cheats Hero mit ESP Wallhack und Aimbot undetected', gallery: 'Enlisted Cheats Galerie — ESP, Aimbot und Wallhack', cta2: 'Features ansehen', h2a: 'Warum Enlisted Cheats 2026 führt', h2b: 'ESP Wallhack, Radar und Aimbot in einer Lizenz', topicA: 'Ideal um feindliche Squads in missions und co-op missions zu lesen.', topicB: 'Eine Lizenz statt separater Tools.' },
	pt: { title: 'Enlisted Cheats 2026 | ESP, Wallhack e Aimbot', desc: 'Cheats Enlisted indetectáveis para Enlisted no PC. ESP wallhack, radar hack e Aimbot com manutenção Gaijin anti-cheat. Entrega digital instantánea.', h1: 'Enlisted Cheats — ESP, Wallhack e Aimbot indetectáveis', intro: 'Pacote undetected para Enlisted no Windows PC: ESP wallhack, radar e Aimbot com manutenção Gaijin anti-cheat após cada patch.', imageAlt: 'Hero enlisted-cheats com ESP wallhack e Aimbot indetectáveis', gallery: 'Galeria Enlisted Cheats — ESP, Aimbot e wallhack', cta2: 'Ver recursos', h2a: 'Por que escolher Enlisted Cheats em 2026', h2b: 'ESP wallhack, radar e Aimbot numa licença', topicA: 'Ideal para ler esquadrões inimigos em BR e co-op missions.', topicB: 'Uma licença em vez de ferramentas separadas.' },
	it: { title: 'Enlisted Cheats 2026 | ESP, Wallhack e Aimbot', desc: 'Cheat Enlisted indetectable per Enlisted su PC. ESP wallhack, radar hack e Aimbot con manutenzione Gaijin anti-cheat. Consegna digitale istantanea.', h1: 'Enlisted Cheats — ESP, Wallhack e Aimbot indetectable', intro: 'Pacchetto undetected per Enlisted su PC Windows: ESP wallhack, radar e Aimbot con manutenzione Gaijin anti-cheat dopo ogni patch.', imageAlt: 'Hero enlisted-cheats con ESP wallhack e Aimbot indetectable', gallery: 'Galleria Enlisted Cheats — ESP, Aimbot e wallhack', cta2: 'Vedi funzioni', h2a: 'Perché scegliere Enlisted Cheats nel 2026', h2b: 'ESP wallhack, radar e Aimbot in una licenza', topicA: 'Ideale per leggere squadre nemiche in missions e co-op missions.', topicB: 'Una licenza invece di tool separati.' },
	nl: { title: 'Enlisted Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected Enlisted cheats voor Enlisted op PC. ESP wallhack, radar hack en Aimbot met Gaijin anti-cheat-onderhoud. Directe digitale levering.', h1: 'Enlisted Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Undetected Windows PC pakket voor Enlisted: ESP wallhack, radar en Aimbot met Gaijin anti-cheat-onderhoud na elke patch.', imageAlt: 'Enlisted-cheats hero met ESP wallhack en Aimbot undetected', gallery: 'Enlisted Cheats galerij — ESP, Aimbot en wallhack', cta2: 'Bekijk functies', h2a: 'Waarom Enlisted Cheats in 2026', h2b: 'ESP wallhack, radar en Aimbot in één licentie', topicA: 'Ideaal om vijandelijke squads te lezen in missions en co-op missions.', topicB: 'Eén licentie in plaats van losse tools.' },
	pl: { title: 'Enlisted Cheats 2026 | ESP, Wallhack i Aimbot', desc: 'Undetected cheaty Enlisted dla Enlisted na PC. ESP wallhack, radar hack i Aimbot z konserwacją Gaijin anti-cheat. Natychmiastowa dostawa cyfrowa.', h1: 'Enlisted Cheats — Undetected ESP, Wallhack i Aimbot', intro: 'Pakiet undetected dla Enlisted na Windows PC: ESP wallhack, radar i Aimbot z konserwacją Gaijin anti-cheat po każdym patchu.', imageAlt: 'Hero enlisted-cheats z ESP wallhack i Aimbot undetected', gallery: 'Galeria Enlisted Cheats — ESP, Aimbot i wallhack', cta2: 'Zobacz funkcje', h2a: 'Dlaczego Enlisted Cheats w 2026', h2b: 'ESP wallhack, radar i Aimbot w jednej licencji', topicA: 'Idealny do czytania wrogich squadów w BR i co-op missions.', topicB: 'Jedna licencja zamiast osobnych narzędzi.' },
	ru: { title: 'Enlisted Cheats 2026 | ESP, Wallhack и Aimbot', desc: 'Undetected читы Enlisted для Enlisted на PC. ESP wallhack, radar hack и Aimbot с обслуживанием Gaijin anti-cheat. Мгновенная цифровая доставка.', h1: 'Enlisted Cheats — Undetected ESP, Wallhack и Aimbot', intro: 'Undetected пакет для Enlisted на Windows PC: ESP wallhack, radar и Aimbot с обслуживанием Gaijin anti-cheat после патчей.', imageAlt: 'Hero enlisted-cheats с ESP wallhack и Aimbot undetected', gallery: 'Галерея Enlisted Cheats — ESP, Aimbot и wallhack', cta2: 'Смотреть функции', h2a: 'Почему выбирают Enlisted Cheats в 2026', h2b: 'ESP wallhack, radar и Aimbot в одной лицензии', topicA: 'Идеально для чтения вражеских отрядов в BR и co-op missions.', topicB: 'Одна лицензия вместо отдельных инструментов.' },
	tr: { title: 'Enlisted Cheats 2026 | ESP, Wallhack ve Aimbot', desc: 'Enlisted için undetected hileler. ESP wallhack, radar hack ve Aimbot — Gaijin anti-cheat bakımı. Anında dijital teslimat.', h1: 'Enlisted Cheats — Undetected ESP, Wallhack ve Aimbot', intro: 'Enlisted Windows PC undetected paketi: ESP wallhack, radar ve Aimbot — Gaijin anti-cheat bakımı dahil.', imageAlt: 'Enlisted-cheats soldier ESP wallhack ve Aimbot undetected', gallery: 'Enlisted Cheats galeri — ESP, Aimbot ve wallhack', cta2: 'Özellikleri gör', h2a: '2026\'da neden Enlisted Cheats', h2b: 'ESP wallhack, radar ve Aimbot tek lisans', topicA: 'BR ve co-op missions\'da düşman squad okumak için ideal.', topicB: 'Ayrı araçlar yerine tek lisans.' },
	ar: { title: 'Enlisted Cheats 2026 | ESP وWallhack وAimbot', desc: 'غش Enlisted undetected لـ Enlisted على PC. ESP wallhack ورadar hack وAimbot مع صيانة Gaijin anti-cheat. تسليم رقمي فوري.', h1: 'Enlisted Cheats — ESP وWallhack وAimbot غير مكتشف', intro: 'حزمة undetected لـ Enlisted على Windows PC: ESP wallhack ورadar وAimbot مع صيانة Gaijin anti-cheat.', imageAlt: 'Hero enlisted-cheats مع ESP wallhack وAimbot undetected', gallery: 'معرض Enlisted Cheats — ESP وAimbot وwallhack', cta2: 'عرض الميزات', h2a: 'لماذا Enlisted Cheats في 2026', h2b: 'ESP wallhack ورadar وAimbot في ترخيص واحد', topicA: 'مثالي لقراءة فرق العدو في BR وco-op missions.', topicB: 'ترخيص واحد بدلاً من أدوات منفصلة.' },
	ja: { title: 'Enlisted Cheats 2026 | ESP・Wallhack・Aimbot', desc: 'Enlisted向けundetectedチート。ESP wallhack、radar hack、Aimbot、Gaijin anti-cheatメンテナンス。即時デジタル配信。', h1: 'Enlisted Cheats — Undetected ESP・Wallhack・Aimbot', intro: 'Enlisted Windows PC向けundetectedパッケージ：ESP wallhack、radar、Aimbot、Gaijin anti-cheatメンテナンス付き。', imageAlt: 'enlisted-cheats soldier ESP wallhackとAimbot undetected', gallery: 'Enlisted Cheatsギャラリー — ESP、Aimbot、wallhack', cta2: '機能を見る', h2a: '2026年にEnlisted Cheatsを選ぶ理由', h2b: 'ESP wallhack、radar、Aimbotが1ライセンス', topicA: 'BRとco-op missionsで敵スクワッドを読むのに最適。', topicB: '別ツールではなく1ライセンス。' },
	ko: { title: 'Enlisted Cheats 2026 | ESP, Wallhack, Aimbot', desc: 'Enlisted undetected 치트. ESP wallhack, radar hack, Aimbot, Gaijin anti-cheat 유지보수. 즉시 디지털 배송.', h1: 'Enlisted Cheats — Undetected ESP, Wallhack, Aimbot', intro: 'Enlisted Windows PC undetected 패키지: ESP wallhack, radar, Aimbot, Gaijin anti-cheat 유지보수 포함.', imageAlt: 'enlisted-cheats soldier ESP wallhack 및 Aimbot undetected', gallery: 'Enlisted Cheats 갤러리 — ESP, Aimbot, wallhack', cta2: '기능 보기', h2a: '2026년 Enlisted Cheats를 선택하는 이유', h2b: 'ESP wallhack, radar, Aimbot 단일 라이선스', topicA: 'BR 및 co-op missions에서 적 분대 읽기에 이상적.', topicB: '별도 도구 대신 단일 라이선스.' },
	zh: { title: 'Enlisted Cheats 2026 | ESP、Wallhack、Aimbot', desc: 'Enlisted undetected作弊。ESP wallhack、radar hack、Aimbot、Gaijin anti-cheat维护。即时数字交付。', h1: 'Enlisted Cheats — Undetected ESP、Wallhack、Aimbot', intro: 'Enlisted Windows PC undetected套餐：ESP wallhack、radar、Aimbot，含Gaijin anti-cheat维护。', imageAlt: 'enlisted-cheats soldier ESP wallhack与Aimbot undetected', gallery: 'Enlisted Cheats图库 — ESP、Aimbot、wallhack', cta2: '查看功能', h2a: '2026年选择Enlisted Cheats的原因', h2b: 'ESP wallhack、radar、Aimbot单一许可证', topicA: '适合在BR和co-op missions中读取敌方小队。', topicB: '一个许可证而非多个工具。' },
	...
	id: { title: 'Enlisted Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Cheat Enlisted undetected untuk Enlisted di PC. ESP wallhack, radar hack, Aimbot, pemeliharaan Gaijin anti-cheat. Pengiriman digital instan.', h1: 'Enlisted Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Paket undetected Enlisted di Windows PC: ESP wallhack, radar, Aimbot dengan pemeliharaan Gaijin anti-cheat.', imageAlt: 'Hero enlisted-cheats ESP wallhack dan Aimbot undetected', gallery: 'Galeri Enlisted Cheats — ESP, Aimbot, wallhack', cta2: 'Lihat fitur', h2a: 'Mengapa Enlisted Cheats di 2026', h2b: 'ESP wallhack, radar, Aimbot dalam satu lisensi', topicA: 'Ideal membaca squad musuh di BR dan co-op missions.', topicB: 'Satu lisensi alih-alih alat terpisah.' },
	...
	vi: { title: 'Enlisted Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Cheat Enlisted undetected cho Enlisted trên PC. ESP wallhack, radar hack, Aimbot, bảo trì Gaijin anti-cheat. Giao hàng kỹ thuật số tức thì.', h1: 'Enlisted Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Gói undetected Enlisted trên Windows PC: ESP wallhack, radar, Aimbot với bảo trì Gaijin anti-cheat.', imageAlt: 'Hero enlisted-cheats ESP wallhack và Aimbot undetected', gallery: 'Thư viện Enlisted Cheats — ESP, Aimbot, wallhack', cta2: 'Xem tính năng', h2a: 'Vì sao chọn Enlisted Cheats 2026', h2b: 'ESP wallhack, radar, Aimbot trong một giấy phép', topicA: 'Lý tưởng đọc squad địch trong BR và co-op missions.', topicB: 'Một giấy phép thay vì công cụ riêng.' },
	uk: { title: 'Enlisted Cheats 2026 | ESP, Wallhack і Aimbot', desc: 'Undetected чіти Enlisted для Enlisted на PC. ESP wallhack, radar hack, Aimbot, обслуговування Gaijin anti-cheat. Мгновенная цифровая доставка.', h1: 'Enlisted Cheats — Undetected ESP, Wallhack і Aimbot', intro: 'Undetected пакет для Enlisted на Windows PC: ESP wallhack, radar, Aimbot з обслуговуванням Gaijin anti-cheat.', imageAlt: 'Hero enlisted-cheats з ESP wallhack і Aimbot undetected', gallery: 'Галерея Enlisted Cheats — ESP, Aimbot, wallhack', cta2: 'Дивитися функції', h2a: 'Чому Enlisted Cheats у 2026', h2b: 'ESP wallhack, radar і Aimbot в одній ліцензії', topicA: 'Ідеально для читання ворожих загонів у BR і co-op missions.', topicB: 'Одна ліцензія замість окремих інструментів.' },
	cs: { title: 'Enlisted Cheats 2026 | ESP, Wallhack a Aimbot', desc: 'Undetected Enlisted cheaty pro Enlisted na PC. ESP wallhack, radar hack, Aimbot, údržba Gaijin anti-cheat. Okamžité digitální doručení.', h1: 'Enlisted Cheats — Undetected ESP, Wallhack a Aimbot', intro: 'Undetected balíček pro Enlisted na Windows PC: ESP wallhack, radar, Aimbot s údržbou Gaijin anti-cheat.', imageAlt: 'Hero enlisted-cheats s ESP wallhack a Aimbot undetected', gallery: 'Galerie Enlisted Cheats — ESP, Aimbot, wallhack', cta2: 'Zobrazit funkce', h2a: 'Proč Enlisted Cheats v roce 2026', h2b: 'ESP wallhack, radar a Aimbot v jedné licenci', topicA: 'Ideální pro čtení nepřátelských squadů v BR a co-op missions.', topicB: 'Jedna licence místo samostatných nástrojů.' },
	ro: { title: 'Enlisted Cheats 2026 | ESP, Wallhack și Aimbot', desc: 'Cheats Enlisted undetected pentru Enlisted pe PC. ESP wallhack, radar hack, Aimbot, mentenanță Gaijin anti-cheat. Livrare digitală instantă.', h1: 'Enlisted Cheats — Undetected ESP, Wallhack și Aimbot', intro: 'Pachet undetected Enlisted pe Windows PC: ESP wallhack, radar, Aimbot cu mentenanță Gaijin anti-cheat.', imageAlt: 'Hero enlisted-cheats cu ESP wallhack și Aimbot undetected', gallery: 'Galerie Enlisted Cheats — ESP, Aimbot, wallhack', cta2: 'Vezi funcții', h2a: 'De ce Enlisted Cheats în 2026', h2b: 'ESP wallhack, radar și Aimbot într-o licență', topicA: 'Ideal pentru citirea squad-urilor inamice în BR și co-op missions.', topicB: 'O licență în loc de instrumente separate.' },
	sv: { title: 'Enlisted Cheats 2026 | ESP, Wallhack & Aimbot', desc: 'Undetected Enlisted cheats för Enlisted på PC. ESP wallhack, radar hack, Aimbot, Gaijin anti-cheat-underhåll. Omedelbar digital leverans.', h1: 'Enlisted Cheats — Undetected ESP, Wallhack & Aimbot', intro: 'Undetected paket för Enlisted på Windows PC: ESP wallhack, radar, Aimbot med Gaijin anti-cheat-underhåll.', imageAlt: 'Enlisted-cheats hero med ESP wallhack och Aimbot undetected', gallery: 'Enlisted Cheats galleri — ESP, Aimbot, wallhack', cta2: 'Se funktioner', h2a: 'Varför Enlisted Cheats 2026', h2b: 'ESP wallhack, radar och Aimbot i en licens', topicA: 'Ideal för att läsa fiendesquads i BR och co-op missions.', topicB: 'En licens istället för separata verktyg.' },
};
...
const PAGE_META_TAILS = {
	...
	undetected: { suffix: 'Anti-cheat safe Status', focus: 'undetected maintenance after Gaijin anti-cheat patches' },
...
const TOPIC_NAMES = {
	...
	'eac-bypass': { en: 'Anti-cheat bypass', es: 'Bypass Gaijin anti-cheat', fr: 'Bypass Gaijin anti-cheat', de: 'Anti-cheat bypass', pt: 'Bypass Gaijin anti-cheat', it: 'Bypass Gaijin anti-cheat', nl: 'Anti-cheat bypass', pl: 'Bypass Gaijin anti-cheat', ru: 'Bypass Gaijin anti-cheat', tr: 'anti-cheat bypass', ar: 'Bypass Gaijin anti-cheat', ja: 'Anti-cheat bypass', ko: 'Anti-cheat bypass', zh: 'Anti-cheat bypass', hi: 'Anti-cheat bypass', id: 'Bypass Gaijin anti-cheat', th: 'Anti-cheat bypass', vi: 'Bypass Gaijin anti-cheat', uk: 'Bypass Gaijin anti-cheat', cs: 'Anti-cheat bypass', ro: 'Bypass Gaijin anti-cheat', sv: 'Anti-cheat bypass' },
