...
const SOURCES = [
	...
	},
	{
		...
		alt: 'Enlisted wallhack ESP with enemy outline boxes and distance readouts in frontline campaigns',
	},
	{
		url: 'https://cdn.wh-satano.ru/smg-wt-s1.webp',
		file: 'enlisted-esp-modules.webp',
		alt: 'Enlisted aimbot lead calculator lock on enemy soldier turret during mission fight',
	},
	{
	...
	},
	{
		...
		alt: 'Enlisted radar hack 2D overlay showing spawn routes and enemy aircraft',
	},
	{
		url: 'https://cdn.wh-satano.ru/wtfecs1.webp',
		file: 'warframe-mission.webp',
		alt: 'Enlisted cheats frontline campaign with ESP boxes and aimbot active on capture zone',
	},
];
